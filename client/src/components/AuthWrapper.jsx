...
import { MdFacebook, MdClose } from "react-icons/md";
    ...
    try {
      ...
      if (email && password) {
        const {
          ...
          type === "login" ? "http://localhost:3001/api/auth/login" : "http://localhost:3001/api/auth/signup",
          { email, password },
          ...
          <div className="flex flex-col justify-center items-center p-8 gap-7">
            <div className="flex">
              <button onClick={handleClose}>
                <MdClose className="absolute right-10 text-2xl" />
